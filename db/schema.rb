...
ActiveRecord::Schema.define(version: 20151103094035) do
  ...
  add_index "emails", ["group_id"], name: "index_emails_on_group_id"
  ...
  add_index "groups", ["email_id"], name: "index_groups_on_email_id"
